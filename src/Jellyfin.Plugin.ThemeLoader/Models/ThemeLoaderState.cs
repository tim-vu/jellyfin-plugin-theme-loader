...
{
    private readonly Dictionary<Guid, InstalledTheme> _installedThemes;

    internal ThemeLoaderState(
        bool enabled,
        Guid? selectedThemeId,
        Dictionary<Guid, InstalledTheme> installedThemes,
    ...
    public InstalledTheme? SelectedTheme => _installedThemes.GetValueOrDefault(SelectedThemeId ?? Guid.Empty);

    public Guid? SelectedThemeId { get; private set; }

    public IReadOnlyDictionary<Guid, InstalledTheme> InstalledThemes => _installedThemes;

    public bool InitializationFailed { get; private set; }

    public InstalledTheme AddTheme(Guid id, string name, string version, string entrypointPath, string directory)
    {
